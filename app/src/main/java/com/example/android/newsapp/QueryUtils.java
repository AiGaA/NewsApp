...
public class QueryUtils {
    ...
    /**
     * Query the Google Books API dataset and return a list of {@link NewsItem} objects.
     */
        ...
        try {
            ...
            if (baseJsonResponse.has("response")) {
                ...
                if (response.has("results")) {
                    ...
                    // For each book in the bookArray, create an {@link NewsItem} object
                    for (int i = 0; i < results.length(); i++) {
                        ...
                        /** Create a new {@link NewsItem} object with the sectionName, title, authors, date and the url from the JSON response.
                         * */
                        NewsItem newsItem = new NewsItem(section, title, date, url);
